...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class CustomEntitiesResult
    {
        ...
        {
            IReadOnlyList<DocumentCustomEntities> documents = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<DocumentCustomEntities> array = new List<DocumentCustomEntities>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(DocumentCustomEntities.DeserializeDocumentCustomEntities(item));
                    }
                    documents = array;
                    continue;
                }
