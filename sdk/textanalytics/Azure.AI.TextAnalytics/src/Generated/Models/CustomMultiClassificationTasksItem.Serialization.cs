...
namespace Azure.AI.TextAnalytics.Models
{
    internal partial class CustomMultiClassificationTasksItem
    {
        ...
        {
            InternalCustomMultiClassificationResult results = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    results = InternalCustomMultiClassificationResult.DeserializeInternalCustomMultiClassificationResult(property.Value);
                    continue;
                }
            ...
            return new CustomMultiClassificationTasksItem(lastUpdateDateTime, name.Value, status, results);
        }
    }
}
