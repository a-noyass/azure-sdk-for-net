...
namespace Azure.AI.TextAnalytics.Models
{
    ...
    {
        internal static DocumentCustomEntities DeserializeDocumentCustomEntities(JsonElement element)
        {
            string id = default;
            ...
            return new DocumentCustomEntities(id, entities, warnings, Optional.ToNullable(statistics));
        }
    }
}
